...
if (typeof Phaser === 'undefined') {
  throw new Error("Error loading module 'LoriUtils'. Its dependency 'Phaser' was not found. Please, check whether 'Phaser' is loaded prior to 'LoriUtils'.");
}
var LoriUtils = function (_, Kotlin, $module$kotlinx_html_js, $module$Phaser) {
  'use strict';
  ...
  return _;
}(typeof LoriUtils === 'undefined' ? {} : LoriUtils, kotlin, this['kotlinx-html-js'], Phaser);
