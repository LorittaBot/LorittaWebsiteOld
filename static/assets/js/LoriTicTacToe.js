...
if (typeof LoriUtils === 'undefined') {
  throw new Error("Error loading module 'LoriTicTacToe'. Its dependency 'LoriUtils' was not found. Please, check whether 'LoriUtils' is loaded prior to 'LoriTicTacToe'.");
}
var LoriTicTacToe = function (_, Kotlin, $module$LoriUtils) {
  'use strict';
  ...
  function TicTacToe$start$lambda_0(this$TicTacToe, closure$notify, closure$pop, closure$followMouse, closure$ko, closure$ts1Promotion) {
    return function (it) {
      ...
      this$TicTacToe.connection = new WebSocket('wss://loritta.website/lorisocket');
  ...
  return _;
}(typeof LoriTicTacToe === 'undefined' ? {} : LoriTicTacToe, kotlin, LoriUtils);
